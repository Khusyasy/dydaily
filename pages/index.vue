  ...
  <div>
    <form
      ...
      <div class="flex-1 w-full sm:w-auto">
        ...
        <input id="task" v-model="form.task" type="text" name="task" required
      ...
      <div class="flex-1 w-full sm:w-auto">
        ...
        <input id="url" v-model="form.url" type="url" name="url"
          class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-cyan-500 sm:text-sm">
      </div>
      ...
      <div class="flex-[0.75] w-full sm:w-auto">
        ...
        <select id="refresh-time" v-model="form.refreshTime" name="refresh-time" required
          class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-cyan-500 sm:text-sm">
    ...
    <div class="max-w-4xl mx-auto my-2 bg-cyan-50/50 shadow rounded relative">
      <div class="flex items-center justify-between sticky top-0 px-4 py-2 bg-cyan-50/50 backdrop-blur z-40">
